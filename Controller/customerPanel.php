...
<head>
  <meta charset="utf-8">
	...
	<title>Welcome | Rent a Car</title>
...
<body>
  ...
  <header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        <img src="../View/assets/img/car.png" alt="" >
              ...
              <div class="row no-gutters">
                ...
                <div class="col-sm-7">
                  <div class="card-body">
                    ...
                    <a href='bookingController.php?carID=<?=$row['carID'];?>'><button class=book>Book</button></a>
                  </div>
                </div>
              </div>
            </div>
    ...
    <section id="terms" class="contact">
      <div class="container">
        <div class="section-title">
          ...
          <p>Rent a Car cars are prominent in Bangladesh for its quality and moderate administrations for the
          ...
          <ul>
            ...
            <li>Rent a Car cars are the easy, hassle free and affordable car rental service provider in Bangladesh.</li>
            <li>If the customer cancels any booking then Rent a Car cars will not impose any charges to the customers.</li>
            ...
            <li>Rent a Car will provide the best transport facility to you as indicated by your prerequisites.</li>
            ...
            <li>If any accident occurs in the roads Rent a Car cars will not take any responsibility.</li>
            ...
            <li>The vehicle will carry only passenger and their belongings. No illegal things are allowed to carry and Rent a Car cars will not take any responsibility of that thing.</li>
